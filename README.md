...
- **[MySQL/MariaDB (binlog)](docs/mysql-binlog.md)**: Triggerless CDC using the binary log — snapshot → stream → resume with GTID (failover-safe) or file+offset checkpoints, plus continuous follow and bounded batch modes
