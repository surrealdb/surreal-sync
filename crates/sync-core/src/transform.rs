...
//! a transform with a schema/catalog (e.g. wrap source-crate FK helpers) and
//! push it into a pipeline. The apply path runs that stage like any other
//! in-place transform — including over [`crate::Relation`] /
//! [`crate::RelationChange`] via the relation methods below.
//!
...
use crate::{Change, Relation, RelationChange, Row, Value};
use anyhow::Result;
...
/// in an external transform or outside this trait.
///
