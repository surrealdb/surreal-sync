...
use crate::client::BinlogClient;
use crate::error::Error;
use crate::event::EventBody;
use crate::types::{BinlogPosition, RowChange, TableMapEvent};

pub struct CdcStream<'a> {
    client: &'a mut BinlogClient,
    table_maps: HashMap<u64, TableMapEvent>,
    current_xid: Option<u64>,
    current_gtid: Option<crate::types::GtidMarker>,
}
...
pub struct CdcChange {
    ...
    pub xid: Option<u64>,
    pub gtid: Option<crate::types::GtidMarker>,
}
