...
//! between the kafka consumer crate and the surreal-sync-kafka::types conversion crate.
//!
...
//! surreal-sync-kafka::types for these definitions.

use crate::types::proto::ProtoMessage;
