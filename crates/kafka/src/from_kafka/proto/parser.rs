...
//!
//! This module parses .proto files and produces ProtoSchema from `crate::types`.
//! The types (ProtoSchema, ProtoMessageDescriptor, ProtoFieldDescriptor, ProtoType)
//! are defined in crate::types; this module provides the parsing logic.

use crate::from_kafka::error::{Error, Result};
use crate::types::{ProtoFieldDescriptor, ProtoMessageDescriptor, ProtoSchema, ProtoType};
...
/// Protobuf schema parser.
///
/// Parses .proto files and produces ProtoSchema compatible with crate::types.
