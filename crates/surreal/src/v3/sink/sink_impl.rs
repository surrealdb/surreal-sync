...
#[async_trait::async_trait]
impl surreal_sync_core::SinkConnect for Surreal3Sink {
...
impl surreal_sync_core::SinkWithCheckpoints for Surreal3Sink {
    type CheckpointStore = crate::v3::checkpoint::Surreal3Store;

    fn table_checkpoints(&self, table: String) -> Self::CheckpointStore {
        crate::v3::checkpoint::Surreal3Store::new(self.client.clone(), table)
    }
}
