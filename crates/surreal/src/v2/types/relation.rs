...
pub struct Relation {
    ...
    pub id: surrealdb2::sql::Thing,
    /// The input (source) record of the relation
    pub input: surrealdb2::sql::Thing,
    /// The output (target) record of the relation
    pub output: surrealdb2::sql::Thing,
...
impl Relation {
    ...
    pub fn get_in(&self) -> surrealdb2::sql::Value {
        surrealdb2::sql::Value::Thing(self.input.clone())
    }

    /// Get the output record as a SurrealDB Value.
    pub fn get_out(&self) -> surrealdb2::sql::Value {
        surrealdb2::sql::Value::Thing(self.output.clone())
    }
    ...
    pub fn get_relate_content(&self) -> surrealdb2::sql::Value {
        ...
        m.insert(
            "id".to_string(),
            surrealdb2::sql::Value::Thing(self.id.clone()),
        );

        surrealdb2::sql::Value::Object(surrealdb2::sql::Object::from(m))
    }
}
...
mod tests {
    ...
    fn test_relation_get_in() {
        ...
        match value {
            surrealdb2::sql::Value::Thing(thing) => {
    ...
    fn test_relation_get_relate_content() {
        ...
        match content {
            surrealdb2::sql::Value::Object(obj) => {
