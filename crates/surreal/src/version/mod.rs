...
//!
//! Utilities to detect the SurrealDB server version by querying the
//! `/version` HTTP endpoint. This is used to select the appropriate SDK
//! version (v2 or v3) since they use incompatible WebSocket subprotocols.
