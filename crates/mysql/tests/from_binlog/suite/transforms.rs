...
async fn identity_pipeline_matches_direct_incremental_sync() -> Result<()> {
    ...
    let mut client = {
        ...
        surreal_sync_mysql::binlog_protocol::BinlogClient::connect(
            surreal_sync_mysql::binlog_protocol::ReplicaOptions {
                host,
                port,
                username: user,
                password: pass,
                server_id: 9_004_001,
                ssl: surreal_sync_mysql::binlog_protocol::SslMode::Disabled,
