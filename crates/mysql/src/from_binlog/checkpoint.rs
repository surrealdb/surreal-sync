...
use crate::binlog_protocol::{BinlogPosition, Flavor, MariaDbGtidList, MySqlGtidSet};
...
impl surreal_sync_core::Checkpoint for BinlogCheckpoint {
...
pub fn get_current_checkpoint(
    client: &crate::binlog_protocol::BinlogClient,
...
) -> Result<crate::binlog_protocol::ResumePosition> {
    use crate::binlog_protocol::ResumePosition;
