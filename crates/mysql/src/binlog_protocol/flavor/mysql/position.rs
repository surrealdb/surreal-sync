...
use crate::binlog_protocol::flavor::mysql::gtid_set::{Gtid, MySqlGtidSet};
...
mod tests {
    ...
    use crate::binlog_protocol::types::QueryEvent;
    ...
    fn gtid_event_then_commit_reports_mysql_gtid() {
        ...
        tracker.on_event(
            &event(
                EventType::Xid,
                200,
                EventBody::Xid(crate::binlog_protocol::types::XidEvent { xid: 42 }),
            ),
            "mysql-bin.000001",
        );
