...
//!
//! The general incremental driver API is [`crate::pipeline::SourceDriver`] /
//! [`crate::pipeline::run_source_runtime`]. [`run_change_feed`] remains a convenience for
//! row-only feeds.
...
///
/// Equivalent to [`crate::pipeline::run_source_runtime`] over a [`ChangeFeedDriver`].
/// Prefer [`crate::pipeline::SourceDriver`] when you need relation events or schema /
