//! Change feed trait: thin adapter over [`crate::pipeline::SourceDriver`] for tests and simple row feeds.
//!
//! Prefer [`crate::pipeline::SourceDriver`] + [`crate::pipeline::run_source_runtime`] for production ports.
//! [`ChangeFeed`] / [`crate::pipeline::run_change_feed`] remain for tests and simple row-CDC sources
...
/// hooks, implement [`crate::pipeline::SourceDriver`] instead (or wrap this feed with
/// [`crate::pipeline::ChangeFeedDriver`]).
...
pub trait ChangeFeed: Send {
    ...
    /// [`SourceDriver::persist_checkpoint`](crate::pipeline::SourceDriver::persist_checkpoint)
    /// unless policy is [`CheckpointPolicy::AdvanceOnly`](crate::pipeline::CheckpointPolicy::AdvanceOnly).
    ...
    /// [`crate::pipeline::run_change_feed`] can exit after draining in-flight work.
