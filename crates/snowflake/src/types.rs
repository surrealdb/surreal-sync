...
//! describing the logical Snowflake type. This module turns a `(cell, column)`
//! pair into a [`surreal_sync_core::Value`], the intermediate representation the
...
//! - The scalar encodings this module depends on:
