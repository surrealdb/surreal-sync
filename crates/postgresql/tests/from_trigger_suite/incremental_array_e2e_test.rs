...
use surreal_sync_postgresql::from_trigger::IncrementalSource;
...
async fn test_incremental_sync_array_e2e() {
    ...
    let mut source =
        surreal_sync_postgresql::from_trigger::PostgresIncrementalSource::new(client.clone(), 0);
    ...
    assert!(
        matches!(col_type, Some(surreal_sync_core::Type::Array { .. })),
