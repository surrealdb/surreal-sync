...
`--all-features` enables `test-support`, which is required to build the `external_stdio` integration test and to export harness doubles used by framework tests.
